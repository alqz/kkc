initKKC({
  ...
  count: 47,
  storageKey: 'kkc-state',
  shareName: 'KKC map',
  clearPrompt: 'Clear all prefectures?',
  formatName: (r) => `${r.name} (${r.en})`,
  formatLabel: (l) => `${l.ja} (${l.label})<small class="block text-s font-normal text-text-secondary mt-[1px]">${l.jaDesc} — ${l.points} points</small>`,
